<template>
  <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <path :class="{ 'wave': true, 'flicker-1': true, 'played': played }" style="fill:#4DBBEB;" d="M352.408,491.948c-5.781,0-11.291-3.361-13.753-8.998c-3.317-7.592,0.147-16.435,7.739-19.751
    ...
    <path :class="{ 'wave': true, 'flicker-2': true, 'played': played }" style="fill:#4DBBEB;" d="M352.413,378.768c-4.118,0-8.218-1.686-11.181-4.995c-5.525-6.173-5.002-15.655,1.171-21.181
    ...
    <path :class="{ 'wave': true, 'flicker-1': true, 'played': played }" style="fill:#2488FF;" d="M482,255.998c0,89.878-53.228,171.208-135.605,207.201c-7.592,3.316-11.057,12.159-7.739,19.751
               c2.462,5.637,7.972,8.998,13.753,8.998c2.005,0,4.043-0.404,5.998-1.259C451.711,449.922,511.999,357.801,512,255.998H482z"/>
    <path :class="{ 'wave': true, 'flicker-2': true, 'played': played }" style="fill:#2488FF;" d="M342.403,352.593c-6.173,5.525-6.696,15.008-1.171,21.181c2.963,3.31,7.063,4.995,11.181,4.995
